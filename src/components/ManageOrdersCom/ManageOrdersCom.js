                ...
                <table className="manage_filter_tables">
                    <div>
                        ...
                        <div className='head_it'>Order #</div>
                            ...
                            <div className='head_it'># of Tickets</div>
                            <div className='head_it'>Total Paid</div>
                            <div className='head_it'>Payment Method</div>
                            <div className='head_it'>More</div>
                        </div>
                    </div>
                    <div className='filter_tables_body'>
                            ...
                            <a href='#popup' className='body_tr' onClick={togglePopup} >
                                ...
                                <div className='head_it'>$450.00</div>
